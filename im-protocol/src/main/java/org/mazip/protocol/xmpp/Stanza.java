...
import static org.mazip.protocol.xmpp.util.StringUtils.requireNotNullOrEmpty;


/**
 * xml节 IQ Message presence
 */
public abstract class Stanza implements TopLevelStreamElement {
    ...
    private final MultiMap<String, ExtensionElement> packetExtensions = new MultiMap<String, ExtensionElement>();
